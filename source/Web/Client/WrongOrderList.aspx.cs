...
public partial class Client_WrongOrderList : System.Web.UI.Page
{
    ...
    {
        PaginationQueryResult<WrongOrder> result = WrongOrderOperation.GetWrongOrderByClientId(PaginationHelper.GetCurrentPaginationQueryCondition(Request), clientSession.Id);
    ...
    protected void btnSerach_ServerClick(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            PaginationQueryResult<WrongOrder> result = WrongOrderOperation.GetWrongOrderByClientIdAndDate(PaginationHelper.GetCurrentPaginationQueryCondition(Request), clientSession.Id, startDate, endDate);
            rpWrongOrder.DataSource = result.Results;
            rpWrongOrder.DataBind();
