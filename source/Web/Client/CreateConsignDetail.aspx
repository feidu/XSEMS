<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CreateConsignDetail.aspx.cs" Inherits="Client_CreateConsignDetail" %>
          ...
          <div id="main_client">
            ...
            <div class="right_bar_client">
              <table class="tablecontent">
                 <tr><td align="left" class="top_content"><wl:ClientTop runat="server" id="clientTop" Title="添加发货明细"></wl:ClientTop></td></tr> 
                 ...
                 <tr>
                  <td><table class="grid">     
                            ...
                            <tr><td colspan="4" align="center"><asp:Button ID="btnCreate" runat="server" CssClass="button" Text="提 交" OnClick="btnCreate_Click"/>&nbsp;&nbsp;&nbsp;<input type="button" class="button" value="返 回" onclick="javascript:location.href='Consign.aspx?id=<%=order.Id %>'"/></td></tr>
                        </table>		
		            </td>
                </tr>
              </table>
