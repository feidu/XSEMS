...
public partial class Admin_Client_LiabilityList : System.Web.UI.Page
{
    User user = null;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        LiabilityOperation.DeleteLiabilityByIds(ids);
        RpLiabilityOrderDataBind();
    }

    private void RpLiabilityOrderDataBind()
    {
        PaginationQueryResult<Liability> result = LiabilityOperation.GetLiabilityByCompanyId(PaginationHelper.GetCurrentPaginationQueryCondition(Request), user.CompanyId);
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            PaginationQueryResult<Liability> result = LiabilityOperation.GetLiabilityByCompanyIdAndDate(PaginationHelper.GetCurrentPaginationQueryCondition(Request), user.CompanyId, startDate, endDate);
            rpRpLiabilityOrder.DataSource = result.Results;
            rpRpLiabilityOrder.DataBind();
