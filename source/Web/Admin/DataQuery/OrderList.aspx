    ...
    <tr>
        <td class="info">
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr><td align="left">跟踪条码：<input id="txtBarCode" runat="server" size="16" class="textBox" /></td><td align="left">客户姓名：<input id="txtClientName" runat="server" size="15" class="textBox" />&nbsp;&nbsp;&nbsp;&nbsp;状态：<asp:DropDownList ID="ddlStatus" runat="server"><asp:ListItem Text="全部" Value="0"></asp:ListItem><asp:ListItem Text="待提交" Value="1"></asp:ListItem><asp:ListItem Text="待审核" Value="2"></asp:ListItem><asp:ListItem Text="已扣货" Value="3"></asp:ListItem><asp:ListItem Text="待检验" Value="4"></asp:ListItem><asp:ListItem Text="已完成" Value="5"></asp:ListItem></asp:DropDownList>&nbsp;&nbsp;&nbsp;&nbsp;所属公司：<wl:CompanyDropDownList ID="ddlCompany" runat="server"></wl:CompanyDropDownList></td><td align="left"><asp:Button ID="btnSearch" runat="server" Text="查 询" CssClass="button" OnClick="btnSearch_Click"/></td></tr>
            </table>
        </td>
    </tr>
    <tr>
