...
public partial class Admin_DataQuery_Quote : System.Web.UI.Page
{
    protected int id = 0;
    Quote quote = null;
    User user = null;
    protected string sCompid = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (int.TryParse(Request.QueryString["id"], out id))
        {
            ...
            sCompid = quote.CompanyId.ToString();
    ...
    private void FormDataBind()
    {
        ...
        txtClientName.Text = quote.Client.RealName;
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        if (client == null)
        {
            lblMsg.Text = "客户不存在，请先将该客户信息&nbsp;<a href='../Client/CreateClient.aspx'> 录入</a> 系统！";
            return;
        }
    ...
    {
        quote.Status = true;
        QuoteOperation.UpdateQuoteStatus(quote);
        QuoteOperation.UpdateQutoeDetailStatusByQuoteId(quote.Id);
        quote.AuditTime = DateTime.Now;
        quote.AuditUserId = user.Id;
        QuoteOperation.UpdateQuoteAuditInfo(quote);
        Response.Write("<script language='javascript' type='text/javascript'>alert('提交成功！');location.href='QuoteList.aspx';</script>");
    }
