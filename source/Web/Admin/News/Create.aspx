<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Create.aspx.cs" Inherits="Admin_News_Create" %>
...
<form id="form1" runat="server">
   <wl:WebSettingNav ID="webSettingNav" Title="添加信息" runat="server" />
    ...
    <tr>
      <td><table class="grid">
          ...
          <tr>
            ...
            <td align="left" valign="middle" class="content"><asp:CheckBox ID="cbxDisplay" runat="server" Checked="true" /></td>
          </tr>
          <tr>
            <td align="left" valign="middle">&nbsp;</td>
            <td align="left" valign="middle"><asp:Button ID="btnCreate" runat="server" OnClientClick="KindSubmit()"  Text="添 加" OnClick="btnCreate_Click" CssClass="button" />&nbsp;&nbsp;&nbsp;<input type="button" class="button" value="返 回" onclick="javascript:location.href='NewsList.aspx';" /></td>
          </tr>
        </table></td>
    </tr>
  </table>
