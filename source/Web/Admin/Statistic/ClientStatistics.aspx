<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ClientStatistics.aspx.cs" Inherits="Admin_Statistic_ClientStatistics" %>
    ...
    <tr>
      <td><table class="grid">  
              ...
              <tr>
                ...
                <tr><td colspan="2" align="center"><asp:Button ID="btnClientStatistic" runat="server" CssClass="button" Text="客户统计" OnClick="btnClientStatistic_Click"/></td></tr>
            </table>		
		</td>
    </tr>
  </table>
