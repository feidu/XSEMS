...
public partial class Admin_Main_Default : System.Web.UI.Page
{
    ...
    "<td width=\"0\"></td>",   
    "<td width=\"60\" onClick=\"menuClickMe(this,'/Admin/Order/?'+new Date());\" onMouseOver=\"menuOverMe(this)\" onmouseout=\"menuOutMe(this)\"> 业务管理</td>",
    "<td width=\"60\" onClick=\"menuClickMe(this,'/Admin/Order/CheckOrderList.aspx?'+new Date());\" onMouseOver=\"menuOverMe(this)\" onmouseout=\"menuOutMe(this)\"> 收件检验</td>",
    "<td width=\"60\" onClick=\"menuClickMe(this,'/Admin/Client/?'+new Date());\" onMouseOver=\"menuOverMe(this)\" onmouseout=\"menuOutMe(this)\"> 客户服务</td>",
    "<td width=\"60\" onClick=\"menuClickMe(this,'/Admin/Finance/?'+new Date());\" onMouseOver=\"menuOverMe(this)\" onmouseout=\"menuOutMe(this)\"> 财务管理</td>",
    "<td width=\"60\" onClick=\"menuClickMe(this,'/Admin/DataQuery/?'+new Date());\" onMouseOver=\"menuOverMe(this)\" onmouseout=\"menuOutMe(this)\"> 数据查询</td>",
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        sb.Append("<td width=\"120\" valign='top'><a href='/Admin/Main'><img src=\"../Images/menu_1.gif\" width=\"120\" height=\"44\" border='0'/></a></td>");
        ...
        sb.Append("<td width=\"60\" onClick=\"menuClickMe(this,'/Admin/Personal/?'+new Date());\" onMouseOver=\"menuOverMe(this)\" onmouseout=\"menuOutMe(this)\">个人信息</td>");
