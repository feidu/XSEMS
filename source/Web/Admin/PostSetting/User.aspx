<%@ Page Language="C#" AutoEventWireup="true" CodeFile="User.aspx.cs" Inherits="Admin_PostSetting_User" %>
...
<form id="form1" runat="server">   
  ...
  <table cellpadding="0" cellspacing="0" class="nav">
    <tr>
        <td class="info2">物流设置 > 公司设定 > 修改员工信息</td>
    </tr>
    <tr>
    ...
    <tr>
      <td><table class="grid">    
                    <tr>
                      ...
                      <td class="content" width="88%"><asp:Label ID="lblUsername" runat="server" Text=""></asp:Label>                          
                      </td>
                    </tr>                                
                    <tr>
                    ...
                    <tr>
                      ...
                      <td class="content"><wl:CompanyDropDownList ID="ddlCompany" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlCompany_SelectIndexChanged"></wl:CompanyDropDownList>
                      </td>
                    </tr>
                    <tr>
                      <td class="label"> 性&nbsp;&nbsp;&nbsp;&nbsp;别: </td>
                      <td class="content"><input type="radio" name="rdoSex" id="rdoSex1"  value="1" runat="server" /><label for="rdoSex1" >男</label>  <input type="radio" name="rdoSex" id="rdoSex2" value="0" runat="server"/><label for="rdoSex2">女</label>
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr><td colspan="2" align="center"><asp:Button ID="btnUpdate" runat="server" CssClass="button" Text="修 改" OnClick="btnUpdate_Click" />&nbsp;&nbsp;&nbsp;<input type="button" class="button" value="返 回" onclick="javascript:location.href='UserList.aspx';" /></td></tr>
                </table>		
        </td>
    </tr>
  </table>
