<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Carrier.aspx.cs" Inherits="Admin_PostSetting_Carrier" %>
...
<form id="form1" runat="server">   
  ...
  <table cellpadding="0" cellspacing="0" class="nav">
    <tr>
        <td class="info2">物流设置 > 承运商设定 > 承运商详情</td>
    </tr>
    <tr>
    ...
    <tr>
      <td><table class="grid">    
                <tr>
                  ...
                  <td class="content" width="36%"><asp:TextBox ID="txtEncode" runat="server" Width="180" Enabled="false"></asp:TextBox>
                  </td>
                ...
                <tr>
                  ...
                  <td class="content"><asp:TextBox ID="txtFuelRate" runat="server" Width="180"></asp:TextBox> (0 - 1之间的数字)
                  </td>
                ...
                <tr>
                  ...
                  <td class="content"><asp:CheckBox ID="chkUseable" runat="server" />
                  </td>
                  <td class="label"> 是否客户端显示: </td>
                  <td class="content"><asp:CheckBox ID="chkClientShow" runat="server" />
                  </td>
                </tr> 
                <tr>
                  <td class="label"> 备&nbsp;&nbsp;&nbsp;&nbsp;注: </td>
                  <td class="content" colspan="3"><asp:TextBox ID="txtRemark" runat="server" Width="100%" TextMode="MultiLine" Rows="4"></asp:TextBox>
                  </td>
                </tr>
                <tr><td colspan="4" align="center"><asp:Button ID="btnUpdate" CssClass="button" runat="server" Text="修 改" OnClick="btnUpdate_Click" />&nbsp;&nbsp;&nbsp;<input type="button" class="button" value="返 回" onclick="javascript:location.href='CarrierList.aspx';" /></td></tr>
            </table>		
        </td>
    </tr>
  </table>
