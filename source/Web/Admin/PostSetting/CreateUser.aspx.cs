...
public partial class Admin_PostSetting_CreateUser : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            company = CompanyOperation.GetCompanyById(companyId);
        }
        result = DepartmentOperation.GetDepartmentByCompanyId(companyId);
        if (!IsPostBack)
        {
            DdlsDataBind();
        }
