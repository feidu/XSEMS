<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CalculateTypeList.aspx.cs" Inherits="Admin_PostSetting_CalculateTypeList" %>
    ...
    <tr>
      <td><table class="grid">
          <tr>
            ...
            <th align="center" class="header">结算方式</th>
            <th align="center" class="header">选择</th>
          </tr>
          <asp:Repeater ID="rpCalculateType" runat="server">
            <ItemTemplate>
              <tr class="label" onmouseover="this.className = 'hover';" onmouseout="this.className = 'label';">
                <td align="center"><asp:Label ID="lblId" runat="server"></asp:Label></td>
                <td align="left"><asp:TextBox ID="txtName" runat="server" Width="300"></asp:TextBox></td>
        ...
        <table class="grid" id="tbCalculateTypeCreate" runat="server">    
                <tr>
                    <td colspan="2" style="height:30px;"></td>
                </tr>
                <tr>
                    <td width="150" align="left" valign="middle" class="header" colspan="2">添加结算方式: </td>
                </tr>
                <tr>
                  <td class="label" width="14%"> 结算方式名称: </td>
