<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PostPlan.aspx.cs" Inherits="Admin_Order_PostPlan" %>
...
<form id="form1" runat="server">   
  ...
  <table cellpadding="0" cellspacing="0" class="nav">
    <tr>
        <td class="info2">业务管理 > 发件计划 > 发件计划详情</td>
    </tr>
    <tr>
  ...
  <table class="tablecontent">
     <tr>
      <td><table class="grid">
                ...
                <tr>
                  <td width="16%" align="right" class="label"> 制 单 人: </td>
                  <td width="84%" align="left" class="content"><asp:Label ID="lblUsername" runat="server" Text=""></asp:Label>
                  </td>
                </tr> 
                <tr>
                  <td width="16%" align="right" class="label"> 制单时间: </td>
                  <td width="84%" align="left" class="content"><asp:Label ID="lblCreateTime" runat="server" Text=""></asp:Label>
                  </td>
                </tr>                
                <tr><td colspan="2" align="center"><asp:Button ID="btnUpdate" runat="server" CssClass="button" Text="修 改" OnClick="btnUpdate_Click" />&nbsp;&nbsp;&nbsp;<input type="button" class="button" value="返 回" onclick="javascript:location.href='PostPlanList.aspx'"/></td></tr>
            </table>		
		</td>
    </tr>
  </table>
