<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CheckOrderView.aspx.cs" Inherits="Admin_Order_CheckOrderView" %>
...
<form id="formCharge" runat="server">     
  ...
  <table cellpadding="0" cellspacing="0" class="nav">
    <tr>
        <td class="info2">业务管理 > 收件明细</td>
    </tr>
    <tr>
        <td class="seperator"></td>
    </tr>
    <tr>
        <td class="info"><input type="button" class="button" value="返 回" onclick="javascript:history.go(-1)"/></td>
    </tr>
  </table>
     ...
     <tr>
      <td><table class="grid">
          ...
          <tr>
            ...
            <td class="content" colspan="5"><asp:Label ID="lblRemark" runat="server"></asp:Label></td>          
          </tr>
          ...
          <tr>
            ...
            <td class="content"><asp:Label ID="lblBarCode" runat="server"></asp:Label></td>
