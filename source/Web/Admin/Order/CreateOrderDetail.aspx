<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CreateOrderDetail.aspx.cs" Inherits="Admin_Order_CreateOrderDetail" %>
...
function getTotalCosts(type) 
{
    ...
    totalCosts=Math.round(parseFloat(totalCosts)*100000);
    totalCosts=totalCosts/100000;
...
<form id="formCharge" runat="server">   
  ...
  <table cellpadding="0" cellspacing="0" class="nav">
    <tr>
        <td class="info2">业务管理 > 收件计划 > 添加收件明细</td>
    </tr>
    <tr>
     ...
     <tr>
      <td><table class="grid">
          <tr>
            ...
            <td width="25%" class="content"><table border="0" cellpadding="0" cellspacing="0" width="100%"><tr><td align="left" width="85%"><input id="txtCountry" type="text" style="width:100%;color:#555555;" runat="server" readonly="readonly"/></td><td align="right" width="15%"><input type="image" src="../Images/btn_bg1.gif" onclick="openCountryWindow()" /></td></tr></table>
                      </td>
          ...
          <tr>            
            ...
            <td class="content"><input id="txtFuelCosts" type="text" style="width: 60px; color: #993333;" runat="server" readonly="readonly" value="0" /> 元</td>  
            <td class="label">偏远地区附加费:</td>
            <td class="content"><input id="txtRemoteCosts" type="text" style="width:60px" runat="server" value="0" onblur="setAddition(this, 2)" onchange="checkData(this);" onkeypress="return checkPrice(event,this.value)" onkeyup="setAddition(this, 2)" onclick="this.select()"/> 元</td>
            <td class="label">取 件 费:</td>
            <td class="content"><input id="txtFetchCosts" type="text" style="width:60px" runat="server" value="0" onblur="setAddition(this, 2)" onchange="checkData(this);" onkeypress="return checkPrice(event,this.value)" onkeyup="setAddition(this, 2)" onclick="this.select()"/> 元</td>                            
          </tr>          
          <tr>
            <td class="label">保 价 费:</td>
            <td class="content"><input id="txtInsureCosts" type="text" style="width:60px" runat="server" value="0" readonly="readonly" /> 元</td>
            <td class="label">地址更改费:</td>
            <td class="content"><input id="txtAddressChangeCosts" type="text" style="width:60px" runat="server" value="0" onblur="setAddition(this, 2)" onchange="checkData(this);" onkeypress="return checkPrice(event,this.value)" onkeyup="setAddition(this, 2)" onclick="this.select()"/> 元</td>
            <td class="label">退 件 费:</td>
            <td class="content"><input id="txtReturnCosts" type="text" style="width:60px" runat="server" value="0" onblur="setAddition(this, 2)" onchange="checkData(this);" onkeypress="return checkPrice(event,this.value)" onkeyup="setAddition(this, 2)" onclick="this.select()" /> 元</td>                
          </tr>
          <tr>            
            <td class="label">材 料 费:</td>
            <td class="content"><input id="txtMaterialCosts" type="text" style="width:60px" runat="server" value="0" onblur="setAddition(this, 2)" onchange="checkData(this);" onkeypress="return checkPrice(event,this.value)" onkeyup="setAddition(this, 2)" onclick="this.select()"/> 元</td>
            <td class="label" >其它费用:</td>
            <td class="content" colspan="3"><input id="txtOtherCosts" type="text" style="width:60px" runat="server" value="0" onkeypress="return checkPrice(event,this.value);" onchange="checkData(this);" onblur="setAddition(this, 2)" onkeyup="setAddition(this, 2)" onclick="this.select()"/> 元&nbsp;&nbsp;费用说明:<input id="txtOtherCostsNote" type="text" style="width:66%;" runat="server"/></td>          
          </tr>
          <tr>
            ...
            <td class="content"><input id="txtTotalCosts" type="text" style="width:60px; color:Blue;" runat="server" readonly="readonly" value="0" /> 元</td>                
          </tr>          
          ...
          <tr>
            ...
            <td class="content" colspan="3"><input id="txtToPostcode" type="text" style="width:180px" runat="server"/></td>                   
          </tr>
          <tr>
            <td class="label">收件人详址:</td>
            <td class="content" colspan="5"><input id="txtToAddress" type="text" style="width:98%" runat="server"/></td>
          </tr>
          <tr><td colspan="6" align="center"><asp:Button ID="btnCreate" runat="server" CssClass="button" Text="添 加" OnClientClick="return checkFreightForms()" OnClick="btnCreate_Click"/>&nbsp;&nbsp;&nbsp;<input type="button" class="button" value="返 回" onclick="javascript:location.href='/Admin/Order/ReceiveOrder.aspx?id=<%=id %>'"/></td></tr>
         </table>
		</td>
    </tr>
  </table>
