<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OrderDetailView.aspx.cs" Inherits="Admin_Order_OrderDetailView" %>
     ...
     <tr>
      <td><table class="grid">
          ...
          <tr>
            ...
            <td class="content"><asp:Label ID="lblRemark" runat="server"></asp:Label></td>  
