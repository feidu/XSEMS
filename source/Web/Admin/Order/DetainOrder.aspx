<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DetainOrder.aspx.cs" Inherits="Admin_Order_DetainOrder" %>
...
<form id="form1" runat="server">   
  ...
  <table cellpadding="0" cellspacing="0" class="nav">
    ...
    <tr>
        <td class="info"><asp:Button ID="btnAuditThrough" runat="server" Text="审核通过" CssClass="button" OnClick="btnAuditThrough_Click" />&nbsp;&nbsp;<asp:Button ID="btnReturn" runat="server" Text="退回审核" CssClass="button" OnClick="btnReturn_Click" />&nbsp;&nbsp;<input type="button" class="button" value="返 回" onclick="javascript:location.href='DetainOrderList.aspx';" /></td>
    </tr>
  </table>
  <table class="tablecontent">
    ...
    <tr>
      <td>
          ...
          <tr>
            <td class="label" style="color:Red;">扣货原因:</td>
