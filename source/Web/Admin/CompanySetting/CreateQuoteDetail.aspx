<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CreateQuoteDetail.aspx.cs" Inherits="Admin_CompanySetting_CreateQuoteDetail" %>
...
<form id="formCharge" runat="server"> 
  ...
  <table cellpadding="0" cellspacing="0" class="nav">
    <tr>
        <td class="info2">公司设置 > 公司设定 > 报价管理 > 添加报价明细</td>
    </tr>
    <tr>
  ...
  <table class="tablecontent">
     ...
     <tr>
      <td><table class="grid">
          ...
          <tr><td colspan="6" align="center"><asp:Button ID="btnCreate" runat="server" CssClass="button" Text="添 加" OnClick="btnCreate_Click" />&nbsp;&nbsp;&nbsp;<input type="button" class="button" value="返 回" onclick="javascript:location.href='/Admin/Order/Quote.aspx?id=<%=id %>'"/></td></tr>          
         </table>
		</td>
    </tr>
  </table>
