<%@ Page Language="C#" AutoEventWireup="true" CodeFile="User.aspx.cs" Inherits="Admin_CompanySetting_User" %>
...
<form id="form1" runat="server">   
  ...
  <table cellpadding="0" cellspacing="0" class="nav">
    <tr>
        <td class="info2">公司设置 > 公司设定 > 员工详情</td>
    </tr>
    <tr>
        <td class="info"><a href="CreateUser.aspx">添加员工</a> | <a href="UserList.aspx">员工列表</a></td>
    </tr>
    <tr>
