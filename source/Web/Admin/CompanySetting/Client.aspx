<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Client.aspx.cs" Inherits="Admin_CompanySetting_Client" %>
...
<form id="form1" runat="server">   
  ...
  <table class="tablecontent">
    ...
    <tr>
      <td><table class="grid">                    
                    <tr>
                      <td class="label" width="12%"> 真实姓名: </td>
                      <td class="content" width="88%"><asp:TextBox ID="txtRealName" runat="server" Width="180"></asp:TextBox>
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td class="content"><asp:TextBox ID="txtCredit" runat="server" Width="180"></asp:TextBox> 元
                      </td>
                    </tr>
