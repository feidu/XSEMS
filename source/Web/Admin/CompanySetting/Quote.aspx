<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Quote.aspx.cs" Inherits="Admin_CompanySetting_Quote" %>
...
<form id="form1" runat="server">   
  ...
  <table cellpadding="0" cellspacing="0" class="nav">
    <tr>
        <td class="info2">公司设置 > 公司设定 > 报价管理 > 报价详情</td>
    </tr>
    <tr>
        <td class="seperator"><input type="hidden" id="hdQuoteDetailCount" value="<%=quoteDetailCount %>"/></td>
    </tr>
    <tr>
        <td class="info"><asp:Button ID="btnUpdate" runat="server" Text="修 改" CssClass="button" OnClick="btnUpdate_Click" />&nbsp;&nbsp;<asp:Button ID="btnDelete" runat="server" Text="删 除" CssClass="button" OnClientClick="return confirm('您确认要删除？');" OnClick="btnDelete_Click" />&nbsp;&nbsp;<asp:Button ID="btnAuditThrough" runat="server" Text="审核通过" CssClass="button" OnClientClick="return checkDetailCount()" OnClick="btnAuditThrough_Click" />&nbsp;&nbsp;<input type="button" class="button" value="返 回" onclick="javascript:location.href='QuoteList.aspx';" /></td>
    </tr>    
  </table>
