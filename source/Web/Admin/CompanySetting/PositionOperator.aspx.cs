...
public partial class Admin_CompanySetting_PositionOperator : System.Web.UI.Page
{
    private int id = 0;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            position = PositionOperation.GetPositionById(id);
        }
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        PositionOperation.UpdatePositionAuthorization(id, mas);
    ...
    private void rpModule_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        foreach (ModuleAuthorization ma in position.ModuleAuthorizations)
        {
