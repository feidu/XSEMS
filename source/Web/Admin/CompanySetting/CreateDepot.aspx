<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CreateDepot.aspx.cs" Inherits="Admin_CompanySetting_CreateDepot" %>
...
<form id="form1" runat="server">   
  ...
  <table cellpadding="0" cellspacing="0" class="nav">
    <tr>
        <td class="info2">公司设置 > 公司设定 > 添加仓库</td>
    </tr>
    <tr>
  ...
  <table class="tablecontent">
    ...
    <tr>
      <td><table class="grid">    
                    ...
                    <tr><td colspan="2" align="center"><asp:Button ID="btnCreate" runat="server" CssClass="button" Text="添 加" OnClick="btnCreate_Click" />&nbsp;&nbsp;&nbsp;<input type="button" class="button" value="返 回" onclick="javascript:location.href='DepotList.aspx';" /></td></tr>
                </table>		
        </td>
    </tr>
  </table>
