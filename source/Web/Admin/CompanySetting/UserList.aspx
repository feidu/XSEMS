<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserList.aspx.cs" Inherits="Admin_CompanySetting_UserList" %>
...
<form id="form1" runat="server">   
  ...
  <table cellpadding="0" cellspacing="0" class="nav">
    <tr>
        <td class="info2">公司设置 > 公司设定 > 员工列表</td>
    </tr>
    <tr>
          ...
          <asp:Repeater ID="rpUser" runat="server">
            <ItemTemplate>
              <tr class="label" onmouseover="this.className = 'hover';" onmouseout="this.className = 'label';">
               ...
               <%-- <td align="left"><asp:TextBox ID="txtCommission" runat="server" Width="70"></asp:TextBox></td>--%>
