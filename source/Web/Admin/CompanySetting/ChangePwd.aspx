<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChangePwd.aspx.cs" Inherits="Admin_CompanySetting_ChangePwd" %>
...
<form id="form1" runat="server">   
  ...
  <table cellpadding="0" cellspacing="0" class="nav">
    <tr>
        <td class="info2">公司设置 > 公司设定 > 修改员工密码</td>
    </tr>
    <tr>
    ...
    <tr>
      <td><table class="grid" >
            ...
            <tr>
              ...
              <td align="left" valign="middle" class="content" ><asp:TextBox ID="txtNewPwd" runat="server" Width="180"  TextMode="Password"></asp:TextBox></td>
            </tr>
            <tr>
