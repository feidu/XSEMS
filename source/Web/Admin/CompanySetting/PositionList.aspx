<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PositionList.aspx.cs" Inherits="Admin_CompanySetting_PositionList" %>
...
<form id="form1" runat="server">   
  ...
  <table cellpadding="0" cellspacing="0" class="nav">
    <tr>
        <td class="info2">公司设置 > 公司设定 > 职位列表</td>
    </tr>
    <tr>
    ...
    <tr>
      <td><table class="grid">
          <tr id="trHeader" runat="server">
            ...
            <th align="center" class="header">职位名称</th>
          ...
          <asp:Repeater ID="rpPosition" runat="server">
            <ItemTemplate>
              <tr class="label" onmouseover="this.className = 'hover';" onmouseout="this.className = 'label';">
                ...
                <td align="center"><a href="PositionList.aspx?pId=<%# Eval("Id") %>">修改</a>&nbsp;|&nbsp;<a href="PositionOperator.aspx?id=<%# Eval("Id") %>">修改权限</a></td>
        ...
        <table class="grid" id="tbPositionUpdate" runat="server">
		  <tr>
            <td colspan="2" style="height:30px;"></td>
          </tr>
		  <tr>
            <td width="150" align="left" valign="middle" class="header">修改当前职位名称: </td>
            <td align="left" valign="middle" class="header"></td>
          </tr>
          <tr>
            <td width="109" align="left" valign="middle" class="label">名称: </td>
            <td width="1022" align="left" valign="middle" class="content"><asp:TextBox ID="txtName" runat="server" Text="" Width="398px"></asp:TextBox></td>
          </tr>
          <tr>
