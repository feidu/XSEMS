<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PostCosts.aspx.cs" Inherits="PostCosts" %>
      ...
      <div id="wrapper2">
        ...
        <div class="margin_t" id="main" style=" padding-bottom:15px;">
          <table class="tablecontent">
             <tr><td align="left" valign="middle"><table border="0" cellpadding="0" cellspacing="0" width="100%"><tr><td width="230">寄达国家：<input id="txtCountry" type="text" style="width:160px;color:#555555;" runat="server" readonly="readonly"/></td><td valign="middle"><input type="image" src="/Admin/Images/btn_bg1.gif" onclick="openCountryWindow()" /></td>
